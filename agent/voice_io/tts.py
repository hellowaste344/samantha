...
EDGE_VOICES: Dict[str, Dict] = {
    "aria":    {"display": "Aria (US Female, warm)",          "gender": "female", "accent": "american",   "edge_name": "en-US-AriaNeural"},
    "jenny":   {"display": "Jenny (US Female, professional)", "gender": "female", "accent": "american",   "edge_name": "en-US-JennyNeural"},
    "guy":     {"display": "Guy (US Male)",                   "gender": "male",   "accent": "american",   "edge_name": "en-US-GuyNeural"},
    "davis":   {"display": "Davis (US Male, casual)",         "gender": "male",   "accent": "american",   "edge_name": "en-US-DavisNeural"},
    "ryan":    {"display": "Ryan (British Male)",             "gender": "male",   "accent": "british",    "edge_name": "en-GB-RyanNeural"},
    "sonia":   {"display": "Sonia (British Female)",          "gender": "female", "accent": "british",    "edge_name": "en-GB-SoniaNeural"},
    "natasha": {"display": "Natasha (Australian Female)",     "gender": "female", "accent": "australian", "edge_name": "en-AU-NatashaNeural"},
    "william": {"display": "William (Australian Male)",       "gender": "male",   "accent": "australian", "edge_name": "en-AU-WilliamNeural"},
    "neerja":  {"display": "Neerja (Indian Female)",          "gender": "female", "accent": "indian",     "edge_name": "en-IN-NeerjaNeural"},
    "prabhat": {"display": "Prabhat (Indian Male)",           "gender": "male",   "accent": "indian",     "edge_name": "en-IN-PrabhatNeural"},
}

# ── Piper offline voice roster ─────────────────────────────────────────────────
PIPER_VOICES: Dict[str, Dict] = {
    "lessac":   {"display": "Lessac (US Female)",        "gender": "female", "accent": "american", "model": "en_US-lessac-medium",        "lang_path": "en/en_US"},
    "amy":      {"display": "Amy (US Female)",           "gender": "female", "accent": "american", "model": "en_US-amy-medium",           "lang_path": "en/en_US"},
    "ryan_us":  {"display": "Ryan (US Male)",            "gender": "male",   "accent": "american", "model": "en_US-ryan-medium",          "lang_path": "en/en_US"},
    "danny":    {"display": "Danny (US Male, light)",    "gender": "male",   "accent": "american", "model": "en_US-danny-low",            "lang_path": "en/en_US"},
    "alan":     {"display": "Alan (British Male)",       "gender": "male",   "accent": "british",  "model": "en_GB-alan-medium",          "lang_path": "en/en_GB"},
    "jenny_gb": {"display": "Jenny (British Female)",    "gender": "female", "accent": "british",  "model": "en_GB-jenny_dioco-medium",   "lang_path": "en/en_GB"},
}
...
_EDGE_TO_PIPER: Dict[str, str] = {
    "aria": "lessac", "jenny": "amy",     "guy": "ryan_us", "davis": "danny",
    "ryan": "alan",   "sonia": "jenny_gb","natasha": "lessac", "william": "ryan_us",
    "neerja": "lessac", "prabhat": "ryan_us",
}
...
class TTS:
    ...
    def _play_audio_file(self, path: str):
        ...
        Cascade: pydub → sounddevice → ffplay → mpg123 → aplay+ffmpeg
        """
    ...
    async def _init_piper(self, voice_key: str) -> bool:
        try:
            ...
            print(f"[TTS] Piper init failed ({type(exc).__name__}): {exc}\n  Trying pyttsx3…")
            return False
    ...
    def _download_piper_voice(self, model_name: str, lang_path: str, models_dir: Path):
        ...
        for filename in [f"{model_name}.onnx", f"{model_name}.onnx.json"]:
            ...
            if last_exc is not None:
                for orphan in [models_dir / f"{model_name}.onnx",
    ...
    def _speak_piper(self, text: str):
        try:
            ...
            sd.play(audio, samplerate=rate, dtype="int16")
            sd.wait()
        except ImportError:
